...
TOOL_DESCRIPTION = (
    "Use Tavily API to search for the latest information. "
    "Call this function if you are not sure about the answer."
)
TOOL_PARAMETERS = {
    "type": "object",
    "properties": {
        "query": {
            "type": "string",
            "description": "The search query to pass to Tavily Search.",
        }
    },
    "required": ["query"],
}
...
class TavilySearchToolExtension(AsyncLLMToolBaseExtension):
    def __init__(self, name: str) -> None:
        ...
        self.session = None
        self.config = None
        self.k = 10  # Number of results to fetch
